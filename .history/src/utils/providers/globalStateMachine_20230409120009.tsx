...
import { getBaseBodyParametersOutModel } from "generated"
...
interface SetDefaultData extends EventObject {
  type: "SET_DEFAULT_DATA"
  data: getBaseBodyParametersOutModel
}
    ...
    fetchDefaultData: {
      on: {
        SET_DEFAULT_DATA: {
          target: "modifyData",
          actions: assign({
            parametersData: (_, event: SetDefaultData) => {
              return event.data.body_params
            },
          }),
        },
        RESTART: {
          ...
          actions: [
            ...
            // Cancel the fetchDefaultData service
          ],
        },
      },
    },
